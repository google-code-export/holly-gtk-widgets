// TableModel.cs created with MonoDevelop
// User: dantes at 3:49 PM 10/5/2008
//
...
namespace HollyLibrary.Table
{
	...
	public class TableModel 
	{
		...
		public class Selection
		{
			...
			/// </summary>
			public Gdk.Rectangle SelectionBounds
			{
				get
				{
					if (this.rows.Count == 0)
			...
			/// <returns></returns>
			internal Gdk.Rectangle CalcSelectionBounds(int start, int end)
			{
