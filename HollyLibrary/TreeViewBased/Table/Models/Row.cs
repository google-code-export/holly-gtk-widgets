// Row.cs created with MonoDevelop
// User: dantes at 3:37 PM 10/5/2008
//
...
namespace HollyLibrary.Table
{
	...
	/// <summary>
	/// Represents a row of Cells displayed in a Table
	/// </summary>
	public class Row : IDisposable
	{
		...
		public Gdk.Color BackColor
		{
			...
			set
			{
				...
				if (!this.RowStyle.BackColor.Equal( value ))
				{
		...
		{
			return (this.rowStyle != null && !this.rowStyle.BackColor.Equals(null));
		}
