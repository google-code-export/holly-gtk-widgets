// Column.cs created with MonoDevelop
// User: dantes at 3:16 PM 10/5/2008
//
...
namespace HollyLibrary.Table
{
	...
	ToolboxItem(false)]
	public abstract class Column : Gtk.Bin
	{
		...
		public Column(string text, Gdk.Pixbuf image) : base()
		{
			this.Init();
		...
		/// <param name="image">The image displayed on the column's header</param>
		/// <param name="width">The column's width</param>
		public Column(string text, Gdk.Pixbuf image, int width) : base()
		{
			this.Init();
		...
		/// <param name="width">The column's width</param>
		/// <param name="visible">Specifies whether the column is visible</param>
		public Column(string text, Gdk.Pixbuf image, int width, bool visible) : base()
		{
			this.Init();
		...
		public Gdk.Pixbuf Image
		{
			...
			set
			{
				if (this.image != value)
				{
					Gdk.Pixbuf oldImage = this.Image;
